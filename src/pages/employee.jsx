...
import EmployeeCard from "../components/employees/employeeform";
    ...
    <>
      ...
      {modelform && (
        <div className="fixed inset-0 bg-transparent bg-opacity-10 backdrop-brightness-30 flex items-center justify-center">
          <div className=" rounded-md shadow-xl w-full max-w-md relative">
            <Button
              onClick={() => setModelForm(false)}
              className="absolute top-2 right-2 text-xs bg-black px-2 py-1 rounded cursor-pointer"
            >
              ✕
            </Button>
            <EmployeeForm
